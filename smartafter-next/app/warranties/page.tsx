...
// Dynamically import the component with no SSR and aggressive optimization
const WarrantiesClient = dynamic(() => import('./WarrantiesClient'), {
  ssr: false,
  loading: () => (
...
export default function WarrantiesPage() {
  ...
  return <WarrantiesClient initialWarranties={[]} error={null} />;
} 